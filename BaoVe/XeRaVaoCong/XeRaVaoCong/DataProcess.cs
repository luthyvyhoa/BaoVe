...
{
    public static class DataProcess<TEntity> where TEntity : class
    {
        ...
        public static IEnumerable<TEntity> Select()
        {
            try
            {
        ...
        public static IEnumerable<TEntity> Executing(string procedureName, params object[] paramsValue)
        {
            try
            {
        ...
        /// <returns>List<TEntity></returns>
        public static IEnumerable<TEntity> Select(Expression<Func<TEntity, bool>> predicate)
        {
            try
            {
                var context = new WMSDBEntities();
        ...
        /// <returns>int</returns>
        public static int Update(params TEntity[] entitys)
        {
            using (var context = new WMSDBEntities())
            {
        ...
        /// <param name="entitys">TEntity</param>
        /// <returns>int</returns>
        public static int Insert(params TEntity[] entitys)
        {
            using (var context = new WMSDBEntities())
            {
                using (var dbContextTransaction = context.Database.BeginTransaction())
        ...
        /// <returns>int</returns>
        private static int InsertErrorLog(ErrorLogs errorLogs)
        {
            using (var context = new WMSDBEntities())
            {
                using (var dbContextTransaction = context.Database.BeginTransaction())
        ...
        /// <returns>int</returns>
        public static int Delete(TEntity entitys)
        {
            using (var context = new WMSDBEntities())
            {
                using (var dbContextTransaction = context.Database.BeginTransaction())
        ...
        /// <returns>int</returns>
        public static int ExecuteNoQuery(string procedureName, params object[] list)
        {
            using (var context = new WMSDBEntities())
            {
                using (var dbContextTransaction = context.Database.BeginTransaction())
        ...
        {
            return AppSetting.CurrentUser.LoginName;
        }
    }
}
